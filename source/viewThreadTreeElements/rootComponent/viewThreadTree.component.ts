...
import {TransformJsonToThreadViewDataset} from '../services/transformJsonToThreadViewDataset';
import {MapCreator} from '../services/mapCreator';
import {TransformToThreadD3node} from '../services/transformToThreadD3node/TransformToThreadD3node';
import {ThreadViewDatasetCreator, ThreadViewDatasetCreatorToken} from '../services/threadviewDatasetCreator';
...
*/
@Component({
    templateUrl: './built/viewThreadTreeElements/rootComponent/viewThreadTree.html',
    styleUrls: ['./built/viewThreadTreeElements/rootComponent/viewThreadTree.css'],
    providers: [ 

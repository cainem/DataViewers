...
export class LinkHelper {
    ...
    static diagonal = d3.svg.diagonal<IThreadD3node>()
            .projection((d : IThreadD3node) => [d.y, d.x]);

    static drawLinks (selection : d3.Selection<d3.layout.tree.Link<IThreadD3node>> | d3.selection.Enter<d3.layout.tree.Link<IThreadD3node>>) :
        d3.Selection<d3.layout.tree.Link<IThreadD3node>> {

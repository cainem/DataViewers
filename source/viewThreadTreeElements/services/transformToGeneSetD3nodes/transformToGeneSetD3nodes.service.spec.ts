...
describe('ConvertToGeneSetD3nodesService tests', () => {
    describe("convert", () => {
        it("when selected thread map contains a simple geneset properties set as expected", () =>  {
            ...
            expect(result[0].threadMapNodeD3nodes[0].threadMapThreadDto).toBe(threadMapNodeDto);
        })
    })
});